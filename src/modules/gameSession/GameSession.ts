...
// import {GameEngine, GameEngineDelegate, Path, RoundData, WinnerResult} from "../gameEngine/GameEngine";
// import {clearInterval} from "timers";
// import {MessagingService} from "../../experimental/MessagingService";
// import {GameSessionPlayerDelegate, GameSessionPlayerService} from "./GameSessionPlayerService";
// import {createScopedLogger} from "../../logger/logger";
// import {GameSessionCallback} from "./GameSessionManager";
// import {PlayerUUID} from "../../types";
// import {Player} from "../player/Player";
//
// type hasJoined = boolean
// type playerGameSession = [Player, hasJoined]
//
...
//     private players: playerGameSession[] = [];
...
//         return this.players.map(([player, _]) => player.uuid);
//     }
//
//     constructor(players: Player[], gameSessionUUID: string, gameSessionCallback: GameSessionCallback) {
//
//         // Initialize the player game session with the provided players
//         this.players = players.map(player => [player, false]);
//
...
//     }
//
//     public playerJoins(player: Player, ws: WebSocket) {
//         this.players = this.players.map(([p, hasJoined]) => {
...
//
//         this.messagingService.registerPlayerSocket(player.uuid, player.socket);
//         const allPlayersJoined = this.players.every(([_, hasJoined]) => hasJoined);
//
//         if (allPlayersJoined) {
//             this.startCountdown();
//         }
